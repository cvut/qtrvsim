...
public:
    ...
    void setupUi(QDialog *NewDialog)
    {
        ...
        group_vm->setGeometry(QRect(10, 10, 471, 331));
        ...
        horizontalSlider_va_base_addr->setGeometry(QRect(210, 40, 131, 21));
        ...
        tlb_groupBox->setGeometry(QRect(20, 180, 431, 131));
        ...
        satp_groupBox->setGeometry(QRect(20, 80, 431, 81));
