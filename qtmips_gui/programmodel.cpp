...
bool ProgramModel::adjustRowAndOffset(int &row, uint32_t address) {
    row = rowCount() / 2;
...
void ProgramModel::update_stage_addr(uint stage, uint32_t addr) {
