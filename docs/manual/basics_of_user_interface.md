...
![QtRvSim main window (empty workspace)](images/gui_elements/user_interface.png)
The interface can be divided into five main areas:
![The QtRvSim interface, divided into main sections](images/gui_elements/user_interface_annotated.png)
...
![QtRvSim with the windows menu open](images/gui_elements/windows_menu.png)
