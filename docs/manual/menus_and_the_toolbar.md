...
![alt text](images/gui_elements/registers.png)
- **Program** (Ctrl+P) – Code view with current instruction highlighting.
![alt text](images/gui_elements/program.png)
- **Memory** (Ctrl+M) – Memory contents.
![alt text](images/gui_elements/memory.png)
- **Program Cache** (Ctrl+Shift+P) – Instruction cache visualization (if enabled).
![alt text](images/gui_elements/program_cache.png)
- **Data Cache** (Ctrl+Shift+M) – Data cache visualization (if enabled).
![alt text](images/gui_elements/data_cache.png)
- **L2 Cache** – Second-level cache view (if enabled).
![alt text](images/gui_elements/l2_cache.png)
- **Branch Predictor** – Displays prediction tables and data (if configured).
![alt text](images/gui_elements/branch_predictor.png)
- **Peripherals** – Container for simulated I/O devices.
![alt text](images/gui_elements/peripherals.png)
- **Terminal** – Simulated serial terminal.
![alt text](images/gui_elements/terminal.png)
- **LCD Display** – Simulated LCD.
![alt text](images/gui_elements/lcd_display.png)
- **Control and Status Registers (CSR)** (Ctrl+I) – CSR panel.
![alt text](images/gui_elements/control_and_status_registers.png)
- **Core View** – Datapath visualization (CPU core).
![alt text](images/gui_elements/core.png)
- **Messages** – Log and feedback panel.
![alt text](images/gui_elements/messages.png)
...
### Toolbar
![Toolbar screenshot](images/gui_elements/toolbar.png)
