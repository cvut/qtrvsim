...
MainWindow::MainWindow(QSettings *settings, QWidget *parent)
    ...
    cache_level2->hide();
    dock_bp_btt.reset(new DockPredictorBTT(this));
    dock_bp_btt->hide();
    ...
    connect(ui->actionBranch_Predictor_Target_table, &QAction::triggered, this, &MainWindow::show_dock_bp_btt);
...
void MainWindow::create_core(
    ...
    // Branch predictor
    dock_bp_btt->setup(machine->core()->get_predictor(), machine->core());
...
SHOW_HANDLER(dock_bp_btt, Qt::RightDockWidgetArea, true)
