...
void DockPredictorBTB::setup(const machine::BranchPredictor* branch_predictor, const machine::Core* core) {
    connect(branch_predictor, &machine::BranchPredictor::update_btb_row_done, this, &DockPredictorBTB::update_row);
    connect(branch_predictor, &machine::BranchPredictor::requested_bht_target_address, this, &DockPredictorBTB::highligh_row_after_prediction);
...
void DockPredictorBTB::update_row(uint16_t index, machine::Address instruction_address, machine::Address target_address) {
