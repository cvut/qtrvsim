...
void DockPredictorBTT::setup(const machine::BranchPredictor* branch_predictor, const machine::Core* core) {
    connect(branch_predictor, &machine::BranchPredictor::updated_btt_row, this, &DockPredictorBTT::update_row);
    connect(branch_predictor, &machine::BranchPredictor::new_prediction, this, &DockPredictorBTT::update_new_prediction);
...
void DockPredictorBTT::update_row(uint16_t index, machine::Address instruction_address, machine::Address target_address) {
...
void DockPredictorBTT::update_new_prediction(machine::PredictionInput input, machine::BranchResult result) {
    UNUSED(result);
