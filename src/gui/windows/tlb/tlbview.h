...
private:
    ...
    unsigned way_index;
    unsigned rows;
    BORROWED std::vector<QGraphicsSimpleTextItem*> validity;
    BORROWED std::vector<QGraphicsSimpleTextItem*> asid;
    BORROWED std::vector<QGraphicsSimpleTextItem*> vpn;
    BORROWED std::vector<QGraphicsSimpleTextItem*> phys;
    unsigned curr_row;
    unsigned last_set;
