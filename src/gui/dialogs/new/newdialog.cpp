...
void NewDialog::config_gui() {
    ...
    ui->itlb_replacement_policy->setCurrentIndex((int)config->tlbc_program().get_tlb_replacement_policy());
    ...
    ui->dtlb_replacement_policy->setCurrentIndex((int)config->tlbc_data().get_tlb_replacement_policy());
    // Memory
