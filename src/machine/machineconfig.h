...
public:
    ...
    void set_bp_address_bits(uint8_t b);
    ...
    uint8_t get_bp_address_bits() const;
    uint8_t get_bp_table_bits() const;
...
private:
    ...
    uint8_t bp_bhr_bits;
    uint8_t bp_address_bits;
    uint8_t bp_table_bits; // bp_bhr_bits + bp_address_bits
};
