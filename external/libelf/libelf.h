...
extern unsigned
    elf_flagdata __P((Elf_Data * __data, Elf_Cmd __cmd, unsigned __flags));
...
extern unsigned
    elf_flagscn __P((Elf_Scn * __scn, Elf_Cmd __cmd, unsigned __flags));
extern unsigned
    elf_flagshdr __P((Elf_Scn * __scn, Elf_Cmd __cmd, unsigned __flags));
